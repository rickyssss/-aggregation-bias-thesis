...
SC = "/tmp/claude-0/-home-user--aggregation-bias-thesis/f477c18c-07ba-5b4c-b8a4-165c7a8c8f8a/scratchpad/ireland"

# variable definitions: (output_name, numerator_col, denominator_col)
VARS = [
    ("birthplace_uk_per1000", "T2_1UKBP", "T2_1TBP"),
    ("birthplace_poland_per1000", "T2_1PLBP", "T2_1TBP"),
    ("birthplace_india_per1000", "T2_1INBP", "T2_1TBP"),
    ("birthplace_other_eu27_per1000", "T2_1EUBP", "T2_1TBP"),
    ("birthplace_rest_of_world_per1000", "T2_1RWBP", "T2_1TBP"),
    ("catholic_per1000", "T2_4CA", "T2_4T"),
    ("no_religion_per1000", "T2_4NR", "T2_4T"),
    ("white_irish_traveller_per1000", "T2_2WIT", "T2_2T"),
    ("asian_or_asian_irish_per1000", "T2_2AAI", "T2_2T"),
    ("black_or_black_irish_per1000", "T2_2BBI", "T2_2T"),
    ("other_white_per1000", "T2_2OW", "T2_2T"),
    ("irish_speaker_per1000", "T3_1YES", "T3_1T"),
]
...
coarse = load(f"{SC}/SAPS_2022_county.csv", "IE0")
fine = load(f"{SC}/SAPS_2022_ED.csv", "IE0")
...
write_csv(coarse, "/home/user/-aggregation-bias-thesis/data/Ireland/ireland_saps_coarse_county.csv")
write_csv(fine, "/home/user/-aggregation-bias-thesis/data/Ireland/ireland_saps_fine_ed.csv")
...
with open(f"{SC}/saps_pairwise.csv", "w", newline="", encoding="utf-8") as f:
